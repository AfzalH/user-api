...
find . -type f -exec sed -i '' -e "s/Afzal Hossain/$author_name/" {} \;
find . -type f -exec sed -i '' -e "s/AfzalH/$author_username/" {} \;
find . -type f -exec sed -i '' -e "s/afzal.csedu@gmail.com/$author_email/" {} \;
find . -type f -exec sed -i '' -e "s/UserApi/$package_name/" {} \;
find . -type f -exec sed -i '' -e "s/Plug and Play User API for Laravel/$package_description/" {} \;
